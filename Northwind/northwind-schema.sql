...
DROP SCHEMA IF EXISTS `u23554607_northwind` ;
CREATE SCHEMA IF NOT EXISTS `u23554607_northwind` DEFAULT CHARACTER SET latin1 ;
USE `u23554607_northwind` ;

-- -----------------------------------------------------
-- Table `u23554607_northwind`.`customers`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u23554607_northwind`.`customers` (
...
-- -----------------------------------------------------
-- Table `u23554607_northwind`.`employees`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u23554607_northwind`.`employees` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `company` VARCHAR(50) NULL DEFAULT NULL,
  `last_name` VARCHAR(50) NULL DEFAULT NULL,
  `first_name` VARCHAR(50) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `u23554607_northwind`.`privileges`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u23554607_northwind`.`privileges` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `u23554607_northwind`.`employee_privileges`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u23554607_northwind`.`employee_privileges` (
  ...
  CONSTRAINT `fk_employee_privileges_employees`
    ...
    REFERENCES `u23554607_northwind`.`employees` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_employee_privileges_privileges`
    FOREIGN KEY (`privilege_id`)
    REFERENCES `u23554607_northwind`.`privileges` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `u23554607_northwind`.`inventory_transaction_types`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u23554607_northwind`.`inventory_transaction_types` (
...
-- -----------------------------------------------------
-- Table `u23554607_northwind`.`shippers`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u23554607_northwind`.`shippers` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `company` VARCHAR(50) NULL DEFAULT NULL,
  `last_name` VARCHAR(50) NULL DEFAULT NULL,
  `first_name` VARCHAR(50) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `u23554607_northwind`.`orders_tax_status`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u23554607_northwind`.`orders_tax_status` (
  `id` TINYINT(4) NOT NULL,
...
-- -----------------------------------------------------
-- Table `u23554607_northwind`.`orders_status`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u23554607_northwind`.`orders_status` (
  `id` TINYINT(4) NOT NULL,
...
-- -----------------------------------------------------
-- Table `u23554607_northwind`.`orders`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u23554607_northwind`.`orders` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_orders_customers`
    ...
    REFERENCES `u23554607_northwind`.`customers` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_orders_shippers`
    ...
    REFERENCES `u23554607_northwind`.`shippers` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_orders_orders_tax_status`
    FOREIGN KEY (`tax_status_id`)
    REFERENCES `u23554607_northwind`.`orders_tax_status` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_orders_orders_status`
    FOREIGN KEY (`status_id`)
    REFERENCES `u23554607_northwind`.`orders_status` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `u23554607_northwind`.`products`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u23554607_northwind`.`products` (
...
-- -----------------------------------------------------
-- Table `u23554607_northwind`.`purchase_order_status`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u23554607_northwind`.`purchase_order_status` (
  `id` INT(11) NOT NULL,
...
-- -----------------------------------------------------
-- Table `u23554607_northwind`.`suppliers`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u23554607_northwind`.`suppliers` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `company` VARCHAR(50) NULL DEFAULT NULL,
  `last_name` VARCHAR(50) NULL DEFAULT NULL,
  `first_name` VARCHAR(50) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `u23554607_northwind`.`purchase_orders`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u23554607_northwind`.`purchase_orders` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_purchase_orders_purchase_order_status`
    FOREIGN KEY (`status_id`)
    REFERENCES `u23554607_northwind`.`purchase_order_status` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_purchase_orders_suppliers`
    FOREIGN KEY (`supplier_id`)
    REFERENCES `u23554607_northwind`.`suppliers` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `u23554607_northwind`.`inventory_transactions`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u23554607_northwind`.`inventory_transactions` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `u23554607_northwind`.`invoices`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u23554607_northwind`.`invoices` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `u23554607_northwind`.`order_details_status`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u23554607_northwind`.`order_details_status` (
  `id` INT(11) NOT NULL,
  `status_name` VARCHAR(50) NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB
...
-- -----------------------------------------------------
-- Table `u23554607_northwind`.`order_details`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u23554607_northwind`.`order_details` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_order_details_order_details_status`
    FOREIGN KEY (`status_id`)
    REFERENCES `u23554607_northwind`.`order_details_status` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `u23554607_northwind`.`purchase_order_details`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u23554607_northwind`.`purchase_order_details` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_purchase_order_details_inventory_transactions`
    ...
    REFERENCES `u23554607_northwind`.`inventory_transactions` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `u23554607_northwind`.`sales_reports`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u23554607_northwind`.`sales_reports` (
...
-- -----------------------------------------------------
-- Table `u23554607_northwind`.`strings`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u23554607_northwind`.`strings` (
